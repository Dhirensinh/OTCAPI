...
@Component({
  selector: 'app-exchange-trade-report',
  templateUrl: './exchange-trade-report.component.html',
  styleUrls: ['./exchange-trade-report.component.css']
})
export class ExchangeTradeReportComponent implements OnInit {
